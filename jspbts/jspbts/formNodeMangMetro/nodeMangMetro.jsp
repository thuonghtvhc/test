...
<title><fmt:message key="Node mang Metro"/></title>
<content tag="heading"><fmt:message key="Node mang Metro"/></content>
...
<tr>
			...
			<td >
				<div style="text-align: right;"><a style="text-align: right;" href="#"><fmt:message key="global.form.themmoi"/></a>&nbsp;</div>
			</td> 
...
<tr>
				...
				<div style="width:100%;overflow:auto;"  class="tableStandar">
					<display:table name="${metroData}"   id="item" requestURI="" pagesize="50" sort="external" export="true">
						<display:column class="centerColumnMana" titleKey="global.list.No"> <c:out value="${item_rowNum}"/> </display:column>
						
						<display:column class="rightColumnMana" property="tenTram" titleKey="Tên trạm"/>
						<display:column class="rightColumnMana" property="loaiTram" titleKey="Loại trạm"/>
