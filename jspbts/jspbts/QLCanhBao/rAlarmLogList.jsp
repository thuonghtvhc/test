	...
	<div align="left">
		...
		<c:choose>
			...
			<c:when test="${netWork == 'PS_CORE'}">
				...
				<%-- <li class=""><a href="${pageContext.request.contextPath}/alarmLog/${function}.htm?netWork=IPBB"><span><fmt:message key="title.tabControls.IPBB"/></span></a></li> --%>
				<li class=""><a href="${pageContext.request.contextPath}/alarmLog/${function}.htm?netWork=4G"><span><fmt:message key="title.tabControls.4G"/></span></a></li>
			</c:when>
			...
			<c:when test="${netWork == '4G'}">
				...
				<li class=""><a href="${pageContext.request.contextPath}/alarmLog/${function}.htm?netWork=PS_CORE"><span><fmt:message key="title.tabControls.PS_CORE"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/alarmLog/${function}.htm?netWork=IPBB"><span><fmt:message key="title.tabControls.IPBB"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/alarmLog/${function}.htm?netWork=4G"><span><fmt:message key="title.tabControls.4G"/></span></a></li>
			</c:when>
		 	<c:otherwise>
...
<input type="hidden" name="isSoundAlarm" id="isSoundAlarm" value="${isSoundAlarm}">
	<table >
			...
			<tr>
				...
				<td >
					<div id='unAlarmMappingName' style = "width: 100%"></div>
				</td>
...
$(document).ready(function(){
	...
	$("#alarmType").change(function(){
		if ($("#alarmType").val() != null && $("#alarmType").val() != '') {
			...
			{
				var alarmVar = cbalarmMappingName.split(",");
				if (alarmVar != null) {
					for (var i=0; i<alarmVar.length; i++) {
						$("#alarmMappingName").jqxDropDownList('checkItem', alarmVar[i] ); 
					}
				}
			}     */
